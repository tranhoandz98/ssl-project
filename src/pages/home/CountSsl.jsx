...
const CountSsl = () => {
    return (
        <div className="w-full mb-4 pt-6 px-6 rounded-xl bg-white shadow-md dark:bg-gray-800">
            <div className="flex justify-between  items-center mb-8">
                <p className="text-xl font-bold">Domain</p>
            </div>
            <div className="flex flex-wrap justify-between items-center pb-8">
                <div className="mb-2 grow-0 shrink-0 basis-auto w-full md:w-6/12 md:px-6 lg:w-3/12 px-3 lg:px-3">
                    <div className="flex items-start">
                        ...
                        <div className="grow ml-6">
                            <p className="font-bold mb-1 text-2xl">25</p>
                ...
                <div className="mb-2 grow-0 shrink-0 basis-auto w-full md:w-6/12 md:px-6 lg:w-3/12 px-3 lg:px-3">
                    <div className="flex items-start">
                        ...
                        <div className="grow ml-6">
                            <p className="font-bold mb-1 text-2xl">10</p>
                ...
                <div className="mb-2 grow-0 shrink-0 basis-auto w-full md:w-6/12 md:px-6 lg:w-3/12 px-3 lg:px-3">
                    <div className="flex items-start">
                        ...
                        <div className="grow ml-6">
                            <p className="font-bold mb-1 text-2xl">5</p>
                ...
                <div className="mb-2 grow-0 shrink-0 basis-auto w-full md:w-6/12 md:px-6 lg:w-3/12 px-3 lg:px-3">
                    <div className="flex items-start">
                        ...
                        <div className="grow ml-6">
                            <p className="font-bold mb-1 text-2xl">40</p>
